...
// - Only *rated* titles additionally get a credits fetch
//   (`getMovieCredits`/`getShowAggregateCredits`) for Director/Actor
//   ranking — the most expensive provider component, so it's scoped to
//   the smallest, most bounded set (see docs/stats.md, "People credits").
//
